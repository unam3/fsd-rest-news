...
passSessionNameIfValidRequest sessionName request =
  if sessionName == noSuchEndpointS
    then noSuchEndpoint
...
instance CheckMethods RequestAndParams where
  ...
  passSessionNameIfAdmin reqAndParams sessionName =
    if isAdmin reqAndParams
      then sessionName
      else noSuchEndpointS

endpointToEitherSessionName ::
     HMS.HashMap ([Text], BS.ByteString) (RequestAndParams -> Either String String)
endpointToEitherSessionName =
  HMS.fromList
    [ ( (["auth"], "POST")
      , passSessionNameIfValidRequest "auth" .
        (decode :: LBS.ByteString -> Maybe AuthRequest) . lbsRequest)
    , ( (["users"], "POST")
      , passSessionNameIfValidRequest "createUser" .
        (decode :: LBS.ByteString -> Maybe CreateUserRequest) . lbsRequest)
    , ((["users"], "GET"), (`passSessionNameIfHasUserId` "getUser"))
    , ( (["users"], "DELETE")
      , \params ->
    ...
    , ( (["authors"], "PATCH")
      , \params ->
          ...
          (decode :: LBS.ByteString -> Maybe EditAuthorRequest) $
          lbsRequest params)
    , ( (["authors"], "GET")
      , \params ->
          passSessionNameIfValidRequest
            (passSessionNameIfAdmin params "getAuthor") .
          (decode :: LBS.ByteString -> Maybe AuthorIdRequest) $
          lbsRequest params)
    , ( (["authors"], "DELETE")
      , \params ->
          passSessionNameIfValidRequest
    ...
    , ( (["categories"], "POST")
      , \params ->
          ...
          (decode :: LBS.ByteString -> Maybe CreateCategoryRequest) $
          lbsRequest params)
    , ( (["categories"], "PATCH")
      , \params ->
          passSessionNameIfValidRequest
            (passSessionNameIfAdmin params "updateCategory") .
          (decode :: LBS.ByteString -> Maybe UpdateCategoryRequest) $
          lbsRequest params)
    , ( (["categories"], "GET")
      , passSessionNameIfValidRequest "getCategory" .
        (decode :: LBS.ByteString -> Maybe CategoryIdRequest) . lbsRequest)
    , ( (["categories"], "DELETE")
      , \params ->
          passSessionNameIfValidRequest
            (passSessionNameIfAdmin params "deleteCategory") .
          (decode :: LBS.ByteString -> Maybe CategoryIdRequest) $
          lbsRequest params)
    , ( (["tags"], "POST")
      , \params ->
          passSessionNameIfValidRequest
            (passSessionNameIfAdmin params "createTag") .
          (decode :: LBS.ByteString -> Maybe CreateTagRequest) $
          lbsRequest params)
    , ( (["tags"], "PATCH")
      , \params ->
          passSessionNameIfValidRequest
            (passSessionNameIfAdmin params "editTag") .
          (decode :: LBS.ByteString -> Maybe EditTagRequest) $
          lbsRequest params)
    , ( (["tags"], "GET")
      , passSessionNameIfValidRequest "getTag" .
        (decode :: LBS.ByteString -> Maybe TagIdRequest) . lbsRequest)
    , ( (["tags"], "DELETE")
      , \params ->
          passSessionNameIfValidRequest
            (passSessionNameIfAdmin params "deleteTag") .
          (decode :: LBS.ByteString -> Maybe TagIdRequest) $
          lbsRequest params)
    , ( (["comments"], "POST")
      , \params ->
          passSessionNameIfValidRequest
            (either id id $ passSessionNameIfHasUserId params "createComment") .
          (decode :: LBS.ByteString -> Maybe CreateCommentRequest) $
          lbsRequest params)
    , ( (["comments"], "GET")
      , passSessionNameIfValidRequest "getArticleComments" .
    ...
    , ( (["articles"], "POST")
      , \params ->
          if isJust (decode $ lbsRequest params :: Maybe ArticleDraftRequest)
            then passSessionNameIfHasAuthorId params "createArticleDraft"
            else passSessionNameIfValidRequest
                   (either id id $
                    passSessionNameIfHasAuthorId params "publishArticleDraft")
                   (decode $ lbsRequest params :: Maybe ArticleDraftIdRequest))
    , ( (["articles"], "PATCH")
      , \params ->
          passSessionNameIfValidRequest
            (either id id $
             passSessionNameIfHasAuthorId params "editArticleDraft") .
          (decode :: LBS.ByteString -> Maybe ArticleDraftEditRequest) $
          lbsRequest params)
    , ( (["articles"], "GET")
      , \params ->
          passSessionNameIfValidRequest
            (either id id $
             passSessionNameIfHasAuthorId params "getArticleDraft") .
          (decode :: LBS.ByteString -> Maybe ArticleDraftIdRequest) $
          lbsRequest params)
    , ( (["articles"], "DELETE")
      , \params ->
          passSessionNameIfValidRequest
            (either id id $
             passSessionNameIfHasAuthorId params "deleteArticleDraft") .
          (decode :: LBS.ByteString -> Maybe ArticleDraftIdRequest) $
          lbsRequest params)
    , ( (["articles", "category"], "GET")
      , passSessionNameIfValidRequest "getArticlesByCategoryId" .
        (decode :: LBS.ByteString -> Maybe ArticlesByCategoryIdRequest) .
        lbsRequest)
    , ( (["articles", "tag"], "GET")
      , passSessionNameIfValidRequest "getArticlesByTagId" .
        (decode :: LBS.ByteString -> Maybe TagIdRequestWithOffset) . lbsRequest)
    , ( (["articles", "tags__any"], "GET")
      , passSessionNameIfValidRequest "getArticlesByAnyTagId" .
        (decode :: LBS.ByteString -> Maybe ArticlesByTagIdListRequest) .
        lbsRequest)
    , ( (["articles", "tags__all"], "GET")
      , passSessionNameIfValidRequest "getArticlesByAllTagId" .
        (decode :: LBS.ByteString -> Maybe ArticlesByTagIdListRequest) .
        lbsRequest)
    , ( (["articles", "in__title"], "GET")
      , passSessionNameIfValidRequest "getArticlesByTitlePart" .
        (decode :: LBS.ByteString -> Maybe ArticlesByTitlePartRequest) .
        lbsRequest)
    , ( (["articles", "in__content"], "GET")
      , passSessionNameIfValidRequest "getArticlesByContentPart" .
        (decode :: LBS.ByteString -> Maybe ArticlesByContentPartRequest) .
        lbsRequest)
    , ( (["articles", "in__author_name"], "GET")
      , passSessionNameIfValidRequest "getArticlesByAuthorNamePart" .
        (decode :: LBS.ByteString -> Maybe ArticlesByAuthorNamePartRequest) .
        lbsRequest)
    , ( (["articles", "byPhotosNumber"], "GET")
      , passSessionNameIfValidRequest "getArticlesSortedByPhotosNumber" .
        (decode :: LBS.ByteString -> Maybe OffsetRequest) . lbsRequest)
    , ( (["articles", "byCreationDate"], "GET")
      , passSessionNameIfValidRequest "getArticlesSortedByCreationDate" .
        (decode :: LBS.ByteString -> Maybe OffsetRequest) . lbsRequest)
    , ( (["articles", "sortByAuthor"], "GET")
      , passSessionNameIfValidRequest "getArticlesSortedByAuthor" .
        (decode :: LBS.ByteString -> Maybe OffsetRequest) . lbsRequest)
    , ( (["articles", "sortByCategory"], "GET")
      , passSessionNameIfValidRequest "getArticlesSortedByCategory" .
        (decode :: LBS.ByteString -> Maybe OffsetRequest) . lbsRequest)
    , ( (["articles", "createdAt"], "GET")
      , passSessionNameIfValidRequest "getArticlesFilteredByCreationDate" .
        (decode :: LBS.ByteString -> Maybe ArticlesByCreationDateRequest) .
        lbsRequest)
    , ( (["articles", "createdBefore"], "GET")
      , passSessionNameIfValidRequest "getArticlesCreatedBeforeDate" .
        (decode :: LBS.ByteString -> Maybe ArticlesByCreationDateRequest) .
        lbsRequest)
    , ( (["articles", "createdAfter"], "GET")
      , passSessionNameIfValidRequest "getArticlesCreatedAfterDate" .
        (decode :: LBS.ByteString -> Maybe ArticlesByCreationDateRequest) .
        lbsRequest)
    ]
