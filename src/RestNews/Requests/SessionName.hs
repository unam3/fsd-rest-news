...
getSessionName pathAndMethod =
  case pathAndMethod of
    ...
    (["articles", "in__author_name"], "GET") ->
      Right "getArticlesByAuthorNamePart"
    (["articles", "byPhotosNumber"], "GET") ->
      Right "getArticlesSortedByPhotosNumber"
    (["articles", "byCreationDate"], "GET") ->
      Right "getArticlesSortedByCreationDate"
    (["articles", "sortByAuthor"], "GET") -> Right "getArticlesSortedByAuthor"
    (["articles", "sortByCategory"], "GET") ->
      Right "getArticlesSortedByCategory"
    (["articles", "createdAt"], "GET") ->
      Right "getArticlesFilteredByCreationDate"
    (["articles", "createdBefore"], "GET") ->
      Right "getArticlesCreatedBeforeDate"
