...
curl -i -H 'Cookie: SESSION='${SESSION} -X PATCH -d '{"article_title": "PATCHED", "category_id": 1, "article_content": "PATCHED", "article_id": 9, "main_photo": "fs", "additional_photos": ["9", "2"], "tags": [1,2]}' http://0.0.0.0:8081/articles

# publish article draft
curl -i -H 'Cookie: SESSION='${SESSION} -X POST -d '{"article_id": 10}' http://0.0.0.0:8081/articles

curl -i -H 'Cookie: SESSION='${SESSION} -X GET -d '{"article_id": 9}' http://0.0.0.0:8081/articles
